(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,51263,e=>{"use strict";var t=e.i(50198);e.s(["useLoader",()=>t.G])},77164,e=>{"use strict";e.s(["assetPath",0,"/showroom/nextjs-playground"])},30754,e=>{"use strict";var t=e.i(50198);e.s(["extend",()=>t.e])},82913,e=>{"use strict";var t=e.i(21348);e.s(["shaderMaterial",0,function(e,r,u,i){var n;return(n=class extends t.ShaderMaterial{constructor(n){for(const i in super({vertexShader:r,fragmentShader:u,...n}),e)this.uniforms[i]=new t.Uniform(e[i]),Object.defineProperty(this,i,{get(){return this.uniforms[i].value},set(e){this.uniforms[i].value=e}});this.uniforms=t.UniformsUtils.clone(this.uniforms),null==i||i(this)}}).key=t.MathUtils.generateUUID(),n}])},68125,e=>{"use strict";var t=e.i(73401),r=e.i(82913),u=e.i(41073),i=e.i(51263),n=e.i(23638),s=e.i(30754),o=e.i(8996),l=e.i(21348),a=e.i(77164);let c=(0,r.shaderMaterial)({u_tex_1:null,u_tex_2:null,u_duration:2,u_time:0},`
  varying vec2 vUv;
  void main() {
    vUv = uv;
