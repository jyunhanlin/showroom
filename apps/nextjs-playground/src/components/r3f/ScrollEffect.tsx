...
const Images = () => {
  ...
  return (
    <group ref={group}>
      <Image position={[-2, 0, 0]} scale={[4, height]} url={`${assetPath}/img/scroll-effect/1.jpeg`} />
      <Image position={[2, 0, 1]} scale={3} url={`${assetPath}/img/scroll-effect/2.jpeg`} />
      <Image position={[-2.3, -height, 2]} scale={[1, 3]} url={`${assetPath}/img/scroll-effect/3.jpeg`} />
      <Image position={[-0.6, -height, 3]} scale={[1, 2]} url={`${assetPath}/img/scroll-effect/4.jpeg`} />
      <Image position={[0.75, -height, 3.5]} scale={1.5} url={`${assetPath}/img/scroll-effect/5.jpeg`} />
      <Image position={[0, -height * 1.5, 2.5]} scale={[1.5, 3]} url={`${assetPath}/img/scroll-effect/6.jpeg`} />
      <Image
