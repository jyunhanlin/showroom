import{i as e,l as t,n,r,s as i}from"./lib-D-7CVURP.js";import{a}from"./canvas-Ds0p6qbM.js";import{t as o}from"./random-CLvj9KOS.js";import{t as s}from"./range-twbD2NVu.js";var c=t(e(),1),l=r(),u=1e3,d=500,f=5,p=32,m=64,h=0;function g(){let[e,t]=(0,c.useState)(!1),[n,r]=(0,c.useState)(!1),[i,g]=(0,c.useState)([]),_=(0,c.useRef)([]);(0,c.useEffect)(()=>()=>{_.current.forEach(e=>window.clearTimeout(e))},[]);function v(){let e=!n;if(r(e),!e)return;let t=s(f).map(e=>{let t=360/f*e+o(-40,40,!0),n=o(p,m,!0),{x:r,y:i}=a(t,n);return{id:h++,x:r,y:i}}),i=t.map(e=>e.id);g(e=>[...e,...t]);let c=window.setTimeout(()=>{g(e=>e.filter(e=>!i.includes(e.id)))},1200);_.current.push(c)}return(0,l.jsxs)(`div`,{className:`flex flex-col items-center gap-3`,"data-reduced":e?`true`:`false`,children:[(0,l.jsx)(`style`,{children:`
      ...
      `}),(0,l.jsx)(`div`,{className:`flex gap-2 rounded-md bg-slate-900 p-4`,children:s(8).map(t=>(0,l.jsx)(`div`,{className:`h-6 w-6 rounded-full`,style:{backgroundColor:`oklch(0.85 0.18 60)`,opacity:e?void 0:.6,animation:e?`wham-a11y-blink 1200ms ease-in-out ${t*150}ms infinite`:`none`}},t))}),(0,l.jsx)(`button`,{type:`button`,onClick:()=>t(e=>!e),className:`rounded bg-slate-800 px-3 py-1 font-mono text-xs text-white hover:bg-slate-700`,children:e?`pause`:`play`}),(0,l.jsx)(`p`,{className:`text-xs text-gray-500`,children:`八顆球都站在原地,只是依序閃爍。但大腦會把它讀成「光在跑」 — 對動暈症使用者一樣有風險。`})]})}var v=i({default:()=>x,frontmatter:()=>y}),y={title:`Motion Accessibility, prefers-reduced-motion`,sourceUrl:`https://courses.joshwcomeau.com/wham/01-particles/11-motion-accessibility`,lessonNumber:`01-particles/11-motion-accessibility`,order:18,summary:"`prefers-reduced-motion` 是 OS 層級的偏好,網站要主動尊重。建議用「motion-free by default」寫法 — 預設不動,只在 `no-preference` 時才開動畫,連舊瀏覽器都會默默退化成靜態。",tags:[`particles`,`accessibility`,`prefers-reduced-motion`,`a11y`]};function b(e){let t={code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,ul:`ul`,...n(),...e.components},{DemoFrame:r}=t;return r||S(`DemoFrame`,!0),(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(t.h2,{children:`TL;DR`}),`
...
`]})]})}function x(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(b,{...e})}):b(e)}function S(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{v as n,y as t};