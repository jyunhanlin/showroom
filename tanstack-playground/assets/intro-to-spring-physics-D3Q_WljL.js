...
`,(0,s.jsxs)(t.li,{children:[(0,s.jsx)(t.strong,{children:`Mass`}),`：物體質量。Comeau 說「我從不調這個」 — 1 永遠 ok，調 stiffness/damping 比較直觀。`]}),`
...
`,(0,s.jsxs)(t.p,{children:[`Comeau 提到 mass 純粹是 completeness（library 都有這 param）。`,(0,s.jsx)(t.strong,{children:`保持 mass=1 一輩子都不會踩到坑`}),`。`]}),`
