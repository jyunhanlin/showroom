...
`,(0,l.jsxs)(t.p,{children:[`替代方案是聽 `,(0,l.jsx)(t.code,{children:`animationend`}),` 事件,但 Comeau 不愛 — 因為:`]}),`
`,(0,l.jsxs)(t.ul,{children:[`
...
`,(0,l.jsxs)(t.li,{children:[(0,l.jsx)(t.strong,{children:`疊到爆`}),`:popping circle 三條 + heart 一條 + 粒子兩條(fade + disperse) + twinkle = 一個按鈕 7 條 keyframe。Comeau 自己也說「things are getting gnarly」 — 把 keyframe 集中放一處、用 CSS 變數抽 duration 是最低限度的整理。`]}),`
