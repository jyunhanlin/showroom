import{n as e,r as t,s as n}from"./lib-D-7CVURP.js";import{r}from"./view-transitions-DziKZOSw.js";var i=n({default:()=>c,frontmatter:()=>o}),a=t(),o={title:`VT Cross-Document Transitions, page-to-page morph`,sourceUrl:`https://courses.joshwcomeau.com/wham/03-advanced-interactions/07.08-vt-route-transitions`,lessonNumber:`03-advanced-interactions/07.08-vt-route-transitions`,order:26,summary:"CSS 加 `@view-transition {`{` `}`navigation: auto{`}`}` ` 兩個頁面都寫,瀏覽器在 same-origin 連結點擊時自動 trigger VT。共用 `view-transition-name` 的元素會 morph(像 hero image 從 listing 飛到 detail)。傳統 multi-page site 也能玩。",tags:[`advanced-interactions`,`view-transitions`,`navigation`,`ssr`]};function s(t){let n={a:`a`,code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...e(),...t.components},{DemoFrame:i}=n;return i||l(`DemoFrame`,!0),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(n.h2,{children:`TL;DR`}),`
...
`,(0,a.jsxs)(n.ul,{children:[`
`,(0,a.jsxs)(n.li,{children:[(0,a.jsx)(n.strong,{children:`AdBlock 等 extension 注入會中斷 VT`}),`:Josh 實測 AdBlock 把 `,(0,a.jsx)(n.code,{children:`@view-transition`}),` 寫在外部 stylesheet 時 VT 30–40% 機率不 fire,寫在 inline `,(0,a.jsx)(n.code,{children:`<style>`}),` 才穩。`]}),`
...
`]})]})}function c(t={}){let{wrapper:n}={...e(),...t.components};return n?(0,a.jsx)(n,{...t,children:(0,a.jsx)(s,{...t})}):s(t)}function l(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as n,o as t};