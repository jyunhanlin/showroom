import{n as e,r as t,s as n}from"./lib-D-7CVURP.js";var r=n({default:()=>s,frontmatter:()=>a}),i=t(),a={title:`Canvas vs. SVG`,sourceUrl:`https://courses.joshwcomeau.com/wham/04-canvas/03-canvas-vs-svg`,lessonNumber:`04-canvas/03-canvas-vs-svg`,order:3,summary:`Raster vs vector 是兩條完全不同的 rendering 路線。SVG = 向量 DOM，每個形狀是一個 element，瀏覽器可以無限放大、a11y 友善、hit-test 免費；Canvas = imperative pixel buffer，畫完就只剩像素，量大 (>10k particles) 才跑得動。`,tags:[`canvas`,`svg`,`raster`,`vector`,`decision`,`a11y`]};function o(t){let n={a:`a`,code:`code`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...e(),...t.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(n.h2,{children:`TL;DR`}),`
...
`]}),`
`,(0,i.jsx)(n.p,{children:`「有限數量、有意義」靠 SVG；「大量、純視覺」靠 Canvas。Whimsical animation 偏 Canvas 是因為動畫密度高、互動需求低、視覺密度才是重點。`})]})}function s(t={}){let{wrapper:n}={...e(),...t.components};return n?(0,i.jsx)(n,{...t,children:(0,i.jsx)(o,{...t})}):o(t)}export{a as n,r as t};