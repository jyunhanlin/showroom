import{n as e,r as t,s as n}from"./lib-D-7CVURP.js";import{l as r}from"./view-transitions-DziKZOSw.js";var i=n({default:()=>c,frontmatter:()=>o}),a=t(),o={title:`View Transitions Syntax, startViewTransition basics`,sourceUrl:`https://courses.joshwcomeau.com/wham/03-advanced-interactions/07.01-vt-syntax`,lessonNumber:`03-advanced-interactions/07.01-vt-syntax`,order:20,summary:"`document.startViewTransition(updateDOM)` 拍兩張 snapshot 疊在頁面最上層,用 keyframe 補間。`view-transition-name` 把元素分組,`::view-transition-old/new(name)` 套自訂 keyframe。其它沒參與的元素也要有 vt name,否則會被蓋住。",tags:[`advanced-interactions`,`view-transitions`,`css`,`animation`]};function s(t){let n={a:`a`,code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,ul:`ul`,...e(),...t.components},{DemoFrame:i}=n;return i||l(`DemoFrame`,!0),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(n.h2,{children:`TL;DR`}),`
