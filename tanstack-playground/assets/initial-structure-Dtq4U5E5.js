import{i as e,l as t,n,r,s as i}from"./lib-D-7CVURP.js";import{t as a}from"./random-CLvj9KOS.js";import{t as o}from"./range-twbD2NVu.js";var s=t(e(),1),c=r(),l=0,u=5;function d(){let[e,t]=(0,s.useState)(!1),[n,r]=(0,s.useState)([]);function i(){let n=!e;if(t(n),!n)return;let i=o(u).map(()=>({id:l++,top:a(0,100),left:a(0,100)}));r(e=>[...e,...i])}return(0,c.jsxs)(`div`,{className:`flex flex-col items-center gap-3`,children:[(0,c.jsx)(`style`,{children:`
...
`]})]})}function h(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(m,{...e})}):m(e)}function g(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{f as n,p as t};