...
`]}),`
`,(0,r.jsxs)(n.p,{children:[`我這個 demo 用 `,(0,r.jsx)(n.code,{children:`0 / 10 / 16 / 50 / 70 / 130`}),`，從天空到前景樹差近 130 倍。實際數字是 vibes-based — 拉到不舒服就改小、看不出視差就改大。Josh 課程也是直接給數字，沒有公式。`]}),`
...
`,(0,r.jsxs)(n.p,{children:[`Josh 在課裡明說這不是 grey area：parallax 是 `,(0,r.jsx)(n.strong,{children:`vestibular motion sickness 的頭號觸發`}),`，比一般 transition 嚴重很多。前庭敏感的人遇到 parallax 不是「覺得有點晃」，是會立刻頭暈反胃。一定要 wrap：`]}),`
...
`]})]})}function l(t={}){let{wrapper:n}={...e(),...t.components};return n?(0,r.jsx)(n,{...t,children:(0,r.jsx)(c,{...t})}):c(t)}function u(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{o as n,s as t};