import{i as e,l as t,n,r,s as i}from"./lib-D-7CVURP.js";import{a}from"./canvas-Ds0p6qbM.js";import{t as o}from"./random-CLvj9KOS.js";import{t as s}from"./sample-BkPvzYnG.js";var c=t(e(),1),l=r(),u=[`oklch(0.85 0.15 60)`,`oklch(0.8 0.18 40)`,`oklch(0.75 0.18 30)`,`oklch(0.85 0.15 90)`],d=500,f=500,p=50;function m(){if(typeof document>`u`||document.getElementById(`wham-pool-styles`))return;let e=document.createElement(`style`);e.id=`wham-pool-styles`,e.textContent=`
...
`,(0,l.jsx)(t.h2,{children:`為什麼 Josh 不推薦`}),`
...
`]})]})}function b(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(y,{...e})}):y(e)}function x(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{_ as n,v as t};