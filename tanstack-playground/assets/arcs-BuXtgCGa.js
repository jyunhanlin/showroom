...
`,(0,o.jsxs)(t.p,{children:[`實務上幾乎不用 — Josh 自己也說「我從沒用過這個參數」。整個 path 想旋轉的話用 CSS `,(0,o.jsx)(t.code,{children:`transform: rotate()`}),` 對整個 SVG 元素旋轉比較直觀。`]}),`
...
`]})]})}function p(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,o.jsx)(t,{...e,children:(0,o.jsx)(f,{...e})}):f(e)}function m(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as n,u as t};