import{i as e,l as t,n,r,s as i}from"./lib-D-7CVURP.js";import{t as a}from"./random-CLvj9KOS.js";import{t as o}from"./range-twbD2NVu.js";var s=t(e(),1),c=r(),l=1e3,u=500,d=48,f=0;function p(){let[e,t]=(0,s.useState)(`transform`),[n,r]=(0,s.useState)(20),[i,p]=(0,s.useState)(!1),[m,h]=(0,s.useState)([]),g=(0,s.useRef)([]);(0,s.useEffect)(()=>()=>{g.current.forEach(e=>window.clearTimeout(e))},[]);function _(){let e=!i;if(p(e),!e)return;let t=o(n).map(()=>({id:f++,x:a(-48,d),y:a(-48,d),topPct:a(0,100),leftPct:a(0,100)})),r=t.map(e=>e.id);h(e=>[...e,...t]);let s=window.setTimeout(()=>{h(e=>e.filter(e=>!r.includes(e.id)))},1200);g.current.push(s)}return(0,c.jsxs)(`div`,{className:`flex flex-col items-center gap-3`,children:[(0,c.jsx)(`style`,{children:`
      ...
      `}),(0,c.jsxs)(`div`,{className:`flex w-full max-w-md flex-col items-center gap-2 rounded-md bg-slate-900 p-6`,children:[(0,c.jsx)(`p`,{className:`font-mono text-xs text-gray-400`,children:`hover 比較(刻意拉長到 1500ms)`}),(0,c.jsxs)(`div`,{className:`wham-tb-underline-row`,children:[(0,c.jsx)(`span`,{className:`wham-tb-underline-link height`,children:`height`}),(0,c.jsx)(`span`,{className:`wham-tb-underline-link scale`,children:`scaleY`})]})]}),(0,c.jsx)(`p`,{className:`text-xs text-gray-500`,children:"Chromium 上 `transform: scaleY` 會做 sub-pixel 漸層;`height` 只能整像素切換,看起來比較跳。"})]})}var h=i({default:()=>v,frontmatter:()=>g}),g={title:`Transform Benefits, why animate transform over top/left`,sourceUrl:`https://courses.joshwcomeau.com/wham/01-particles/04.02-transform-benefits`,lessonNumber:`01-particles/04.02-transform-benefits`,order:7,summary:`animation 用 transform 而不是 top/left/width/height,除了 GPU 加速 / 跳過 layout,還能在 Chromium 上做 sub-pixel rendering — 動畫看起來比畫面解析度的物理極限還滑順。`,tags:[`particles`,`css`,`transform`,`performance`,`sub-pixel`]};function _(e){let t={code:`code`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components},{DemoFrame:r}=t;return r||y(`DemoFrame`,!0),(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(t.h2,{children:`TL;DR`}),`
...
`]})]})}function v(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(_,{...e})}):_(e)}function y(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as n,g as t};