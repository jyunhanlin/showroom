...
`]}),`
`,(0,o.jsx)(t.p,{children:`Comeau 自己也說「我設計 path syntax 不會放這兩個」。Figma export 會用，看到知道意思即可。`}),`
...
`,(0,o.jsx)(t.li,{children:`但 Comeau 說「複雜曲線用 Figma 畫比手寫 path 容易」，超過 3 個 T/S 串接時建議切到 GUI 工具`}),`
`]}),`
...
`,(0,o.jsxs)(t.li,{children:[(0,o.jsx)(t.strong,{children:`小寫 m 在 path 開頭跟大寫 M 一樣`}),`（沒前一個位置可相對）。Comeau 說「不要寫 m 起手」維持一致性。`]}),`
