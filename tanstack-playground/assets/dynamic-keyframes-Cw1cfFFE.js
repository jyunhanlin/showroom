import{i as e,l as t,n,r,s as i}from"./lib-D-7CVURP.js";import{t as a}from"./random-CLvj9KOS.js";import{t as o}from"./range-twbD2NVu.js";var s=t(e(),1),c=r(),l=`oklch(0.75 0.18 280)`,u=[8,16,32,64];function d(){return(0,c.jsxs)(`div`,{className:`flex flex-col items-center gap-3`,children:[(0,c.jsx)(`style`,{children:`
...
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[`兩者效果一樣,Josh 偏好 dynamic var 法因為跟 `,(0,c.jsx)(t.code,{children:`fadeToTransparent`}),` 一致(都寫 `,(0,c.jsx)(t.code,{children:`to`}),`)。`]}),`
`]}),`
...
`,(0,c.jsx)(t.p,{children:`純粹個人喜好。Josh 個人偏 dynamic var 法。`}),`
...
`]})]})}function x(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(b,{...e})}):b(e)}function S(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{y as n,v as t};