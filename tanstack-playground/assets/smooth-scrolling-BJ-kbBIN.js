import{i as e,l as t,n,r,s as i}from"./lib-D-7CVURP.js";var a=t(e(),1),o=r(),s=[`intro`,`background`,`method`,`results`,`conclusion`];function c(){let e=(0,a.useRef)(null);function t(t){let n=e.current;n&&n.querySelector(`[data-section="${t}"]`)?.scrollIntoView({behavior:`smooth`,block:`start`})}return(0,o.jsxs)(`div`,{className:`flex flex-col items-center gap-3`,children:[(0,o.jsx)(`div`,{className:`flex flex-wrap gap-2`,children:s.map(e=>(0,o.jsxs)(`button`,{type:`button`,onClick:()=>t(e),className:`rounded bg-slate-800 px-3 py-1 font-mono text-xs text-white hover:bg-slate-700`,children:[`jump to `,e]},e))}),(0,o.jsx)(`div`,{ref:e,className:`h-72 w-full max-w-md overflow-y-auto rounded-md bg-slate-100 p-4`,style:{scrollBehavior:`smooth`},children:s.map(e=>(0,o.jsxs)(`section`,{"data-section":e,className:`mb-2 rounded-md bg-white p-6`,children:[(0,o.jsx)(`h3`,{className:`font-bold uppercase`,children:e}),(0,o.jsxs)(`p`,{className:`mt-2 text-sm text-gray-600`,children:[`這裡是 `,e,` section,使用 anchor 點擊跳轉。`]}),(0,o.jsx)(`div`,{className:`h-32`})]},e))}),(0,o.jsx)(`p`,{className:`text-xs text-gray-500`,children:"anchor jump 用 native `behavior: 'smooth'` 是合理應用 — 只是「點擊跳轉」這單一動作有過渡。整頁 scroll 仍正常。"})]})}var l=i({default:()=>f,frontmatter:()=>u}),u={title:`Smooth Scrolling, why Lenis-style libraries are scroll-jacking`,sourceUrl:`https://courses.joshwcomeau.com/wham/03-advanced-interactions/05.06-smooth-scrolling`,lessonNumber:`03-advanced-interactions/05.06-smooth-scrolling`,order:17,summary:"Lenis / GSAP ScrollSmoother 之類的庫把整頁的 scroll 物理重寫成「lerp 過去」 — 對 trackpad 使用者是降級體驗,對動暈症使用者是潛在誘發源。Josh 強烈反對。`scroll-behavior: smooth` 用在 anchor jump 是合理應用。",tags:[`advanced-interactions`,`scroll`,`scrolljacking`,`accessibility`,`opinion`]};function d(e){let t={code:`code`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components},{DemoFrame:r}=t;return r||p(`DemoFrame`,!0),(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(t.h2,{children:`TL;DR`}),`
...
`]})]})}function f(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,o.jsx)(t,{...e,children:(0,o.jsx)(d,{...e})}):d(e)}function p(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as n,u as t};