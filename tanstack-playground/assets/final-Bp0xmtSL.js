...
`,(0,l.jsxs)(t.p,{children:[`Josh 自己在這篇明確說 — 課程裡這個 like-button 效果可以`,(0,l.jsx)(t.strong,{children:`自由用在自己的專案`}),`(包括商業),不需要 attribution。`]}),`
...
`,(0,l.jsxs)(t.p,{children:[`下一篇 `,(0,l.jsx)(t.code,{children:`13.01-particles-in-react`}),` 是課程的 vanilla JS 寫法搬到 React 的 refactor — 但我們本來就在 React,所以那篇對我們是「整理 hook 與 state model」而不是「換實作」。`]})]})}function S(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(x,{...e})}):x(e)}function C(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{b as n,y as t};