...
`,(0,l.jsx)(t.span,{className:`line`,children:(0,l.jsx)(t.span,{style:{color:`#24292E`},children:`}`})})]})})}),`
`,(0,l.jsxs)(t.p,{children:[`注意:這只回傳「呼叫當下」的快照。User 改設定後不會自動 update,要監聽 media query 的 change 事件。React 用 hook 包好(Comeau 部落格的 `,(0,l.jsx)(t.code,{children:`usePrefersReducedMotion`}),`)。`]}),`
...
`,(0,l.jsxs)(t.li,{children:[(0,l.jsx)(t.strong,{children:`不確定就關掉`}),`:Comeau 自己的策略 — 寧可 over-protect,沒人會抱怨「動畫太少」,但會有人因為動畫太多無法用網站。`]}),`
`]}),`
